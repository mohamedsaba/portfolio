...
const Contact = () => {
  return (
    <div className="pt-24 sm:pt-32 pb-16 sm:pb-24 px-6 max-w-6xl mx-auto">
      <SEO 
        title="Connect" 
        description="Schedule an architecture review or discuss backend consulting for your distributed systems."
      />
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
        ...
        >
          <motion.div variants={fadeUp} custom={0}>
            ...
            <h1 className="text-6xl lg:text-8xl font-serif text-paper-text tracking-tightest leading-[0.9] mb-10">
              Let's talk <br /> <span className="italic">Systems</span>.
            </h1>
            <p className="text-xl text-paper-muted leading-relaxed max-w-md font-serif">
              Reach out if you're facing high-concurrency bottlenecks, need an architecture audit, or want to discuss a specific backend implementation.
            </p>
          </motion.div>
        ...
        >
          ...
          <div className="flex items-center space-x-4 mb-12">
            ...
            <h3 className="text-2xl font-serif text-paper-text">Architecture Inquiry</h3>
          </div>
          ...
          <form action="https://formspree.io/f/mqkazpjr" method="POST" className="space-y-10 relative z-10">
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                ...
                >
                  <option>Architecture Review / Audit</option>
                  <option>Backend Consulting</option>
            ...
            <div className="space-y-3">
              ...
              <textarea 
                name="message"
                rows={6}
                placeholder="Tell me about your technical stack and the challenges you're looking to solve..."
